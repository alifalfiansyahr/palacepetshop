  ...
  <div class="container">
    <div class="row block-9">
      <div class="col-md-12 order-md-last d-flex">
        ...
        <form id="form_product" action="<?php echo base_url().'about/edit'; ?>" class="bg-white p-5 contact-form" method="post" enctype="multipart/form-data">
          ...
          ?>
			...
			<div class="form-group row">
				...
				<div class="col-sm-9">
					<img src="<?php echo base_url().'photo/about/'.(($rec->image!=null) ? $rec->image : 'no_picture.jpg'); ?>" width="200px" height="200px">
